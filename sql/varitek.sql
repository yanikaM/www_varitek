...
CREATE TABLE `banks` (
  `b_id` int(6) UNSIGNED ZEROFILL NOT NULL,
  `b_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `b_bank` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `b_logo` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `b_number` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `banks` (`b_id`, `b_name`, `b_bank`, `b_logo`, `b_number`, `bn_name`) VALUES
(000001, 'บริษัท อาซีฟา จำกัด', 'กสิกร', 'images/banks/kbank_logo.png', '9999999999', 'พระราม2');
...
CREATE TABLE `brand` (
  `brand_ID` int(6) UNSIGNED ZEROFILL NOT NULL,
...
(000003, 'Schneider', 'images/brands/2021-01-18-11-53-46_picture.jpg'),
(000004, 'JA Solar', 'images/brands/2021-01-18-11-57-23_picture.png'),
(000005, 'YAZAKI', 'images/brands/2021-01-18-11-57-47_picture.jpg'),
(000006, 'MCI DRAKA', 'images/brands/2021-01-18-11-59-31_picture.png'),
(000007, 'Fuji Electric', 'images/brands/2021-01-18-11-59-54_picture.png'),
(000008, 'Mitsubishi Electric', 'images/brands/2021-01-18-12-00-10_picture.jpg'),
(000009, 'OMRON', 'images/brands/2021-01-18-12-00-32_picture.jpg'),
(000010, 'Phelps Dodge', 'images/brands/2021-01-18-12-00-59_picture.jpg'),
(000011, 'Prysmian', 'images/brands/2021-01-18-12-01-19_picture.png'),
(000012, 'Siemens', 'images/brands/2021-01-18-12-01-42_picture.png');
...
CREATE TABLE `cart` (
  ...
  `Cart_session` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Customer_ID` int NOT NULL,
  `Cart_Status` int NOT NULL COMMENT '0ยกเลิก| 1มีสินค้า | 2สั่งซื้อ',
  `Cart_Action` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `cart_detail` (
  `Cart_Detail_ID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `Cart_session` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_ID` int(6) UNSIGNED ZEROFILL NOT NULL,
  `Products_Qty` int NOT NULL,
  `Products_Price` double NOT NULL,
  `Cart_ID` int(11) UNSIGNED ZEROFILL NOT NULL,
  `Optiondetails_ID` int(6) UNSIGNED ZEROFILL NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `cart_detail` (`Cart_Detail_ID`, `Cart_session`, `Products_ID`, `Products_Qty`, `Products_Price`, `Cart_ID`, `Optiondetails_ID`) VALUES
(0000000042, '', 000001, 1, 100, 00000000008, 000001),
(0000000043, '', 000001, 1, 100, 00000000008, 000002),
(0000000044, '', 000001, 1, 100, 00000000008, 000002),
(0000000045, '', 000001, 1, 100, 00000000000, 000002),
(0000000046, '', 000001, 1, 100, 00000000009, 000002),
(0000000047, '', 000001, 1, 100, 00000000000, 000002),
(0000000048, '', 000001, 1, 100, 00000000010, 000002);
...
CREATE TABLE `customers` (
  ...
  `Customer_Username` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Customer_Password` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Customer_Phone` varchar(20) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Customer_Email` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Customer_Lavel` int NOT NULL DEFAULT '2' COMMENT '1 = Dealer | 2 = Member'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `customers` (`Customer_ID`, `Customer_Name`, `Customer_Username`, `Customer_Password`, `Customer_Phone`, `Customer_Email`, `Customer_Lavel`) VALUES
(0000000001, 'Yanika Muangmee', 'yanika', 'yanika', '0806599023', 'yanika@asefa.co.th', 2),
(0000000006, 'aaa', 'aaa', 'aa', 'sss', '', 2),
(0000000007, 'test', 'test@gamail.com', 'test', '222222', 'test@gamail.com', 2);
...
CREATE TABLE `customers_address` (
  `ca_ID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `ca_name` varchar(500) NOT NULL,
  `ca_phone` varchar(20) NOT NULL,
  `ca_province` varchar(100) NOT NULL,
  `ca_amphure` varchar(100) NOT NULL,
  `ca_district` varchar(100) NOT NULL,
  `ca_postnum` varchar(10) NOT NULL,
  `ca_address` varchar(500) NOT NULL,
  `Customer_ID` int(10) UNSIGNED ZEROFILL NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `customers_address` (`ca_ID`, `ca_name`, `ca_phone`, `ca_province`, `ca_amphure`, `ca_district`, `ca_postnum`, `ca_address`, `Customer_ID`) VALUES
(0000000001, 'ญานิกา ม่วงหมี', '0806599023', 'กรุงเทพมหานคร', 'เขตบางแค', 'บางแค', '10160', '180 ถ.กาญจนาภิเษก', 0000000001),
(0000000004, 'ญานิกา ม่วงหมี', '0612249947', 'สมุทรสาคร', 'เมืองสมุทรสาคร', 'มหาชัย', '74000', 'บ้านโชคอรุณ ซ.ท่าปรง7', 0000000001);
...
CREATE TABLE `employees` (
  `Emp_ID` int NOT NULL,
  `Emp_username` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Emp_password` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Emp_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Emp_pic` varchar(100) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Employees_ID` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Emp_permistion` int NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `employees` (`Emp_ID`, `Emp_username`, `Emp_password`, `Emp_name`, `Emp_pic`, `Employees_ID`, `Emp_permistion`) VALUES
(1, 'admin', 'admin', 'Yanika Muangmee', 'img/admin/yanika.jpg', '630500037', 1);
...
CREATE TABLE `news` (
  ...
  `news_detail` varchar(10000) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `orders` (
  `Orders_ID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `Orders_No` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Customer_ID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `ca_ID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `Admin_ID` int DEFAULT NULL,
  `Orders_Date` date NOT NULL,
  `Orders_Status` int NOT NULL COMMENT '0ยกเลิก|1รอชำระเงิน|2รอจัดส่ง',
  `Orders_TAG` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DateCreate` datetime NOT NULL,
  `LastUpdate` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `orders` (`Orders_ID`, `Orders_No`, `Customer_ID`, `ca_ID`, `Admin_ID`, `Orders_Date`, `Orders_Status`, `Orders_TAG`, `DateCreate`, `LastUpdate`) VALUES
(0000000060, 'ORD202101-0007', 0000000001, 0000000001, NULL, '2021-01-18', 1, '', '2021-01-18 08:59:30', '2021-01-18 08:59:30'),
(0000000061, 'ORD202101-0002', 0000000001, 0000000001, NULL, '2021-01-18', 4, 'EE993673545CN', '2021-01-18 09:51:22', '2021-01-18 10:39:49'),
(0000000062, 'ORD202101-0003', 0000000001, 0000000004, NULL, '2021-01-18', 1, '', '2021-01-18 15:41:47', '2021-01-18 15:41:47'),
(0000000063, 'ORD202101-0004', 0000000001, 0000000001, NULL, '2021-01-20', 2, '', '2021-01-20 06:30:10', '2021-01-20 08:14:47'),
(0000000064, 'ORD202101-0005', 0000000001, 0000000004, NULL, '2021-01-20', 0, '', '2021-01-20 06:30:40', '2021-01-20 06:31:10');
...
CREATE TABLE `orders_detail` (
  `Orders_Detail_ID` int(11) UNSIGNED ZEROFILL NOT NULL,
  `Orders_No` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `orders_detail` (`Orders_Detail_ID`, `Orders_No`, `Products_ID`, `Products_Qty`) VALUES
(00000000052, 'ORD202101-0007', 52, 1),
(00000000053, 'ORD202101-0007', 54, 1),
(00000000054, 'ORD202101-0002', 51, 6),
(00000000055, 'ORD202101-0002', 54, 6),
(00000000056, 'ORD202101-0002', 52, 6),
(00000000057, 'ORD202101-0002', 49, 6),
(00000000058, 'ORD202101-0003', 49, 3),
(00000000059, 'ORD202101-0003', 54, 3),
(00000000060, 'ORD202101-0003', 52, 3),
(00000000061, 'ORD202101-0003', 51, 3),
(00000000062, 'ORD202101-0004', 52, 5),
(00000000063, 'ORD202101-0004', 49, 5),
(00000000064, 'ORD202101-0004', 50, 5),
(00000000065, 'ORD202101-0004', 51, 5),
(00000000066, 'ORD202101-0004', 54, 5),
(00000000067, 'ORD202101-0005', 51, 1),
(00000000068, 'ORD202101-0005', 50, 1);
...
CREATE TABLE `payments` (
  `payments_ID` int(11) UNSIGNED ZEROFILL NOT NULL,
  `Customers_ID` int NOT NULL,
  `Employees_ID` int DEFAULT NULL,
  `Orders_No` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `payments_Method` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `payments_Detail` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `payments_File` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `payments_Date` datetime NOT NULL,
  `payments_Status` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `payments` (`payments_ID`, `Customers_ID`, `Employees_ID`, `Orders_No`, `payments_Method`, `payments_Detail`, `payments_File`, `payments_Date`, `payments_Status`) VALUES
(00000000007, 1, NULL, 'ORD202101-0002', 'โอนเข้าบัญชี', NULL, 'images/slips/ORD202101-0002-slip_picture.jpg', '2021-01-18 10:39:49', 1),
(00000000008, 1, NULL, 'ORD202101-0004', 'โอนเข้าบัญชี', NULL, 'images/slips/ORD202101-0004-slip_picture.jpg', '2021-01-20 08:14:47', 1);
...
CREATE TABLE `products` (
  `Products_ID` int(6) UNSIGNED ZEROFILL NOT NULL,
  `Types_ID` int(4) UNSIGNED ZEROFILL NOT NULL,
  `Categorys_ID` int(4) UNSIGNED ZEROFILL NOT NULL,
  `brand_ID` int(6) UNSIGNED ZEROFILL NOT NULL,
  `Products_Code` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_Code2` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_Description` text CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_Option1` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Option2` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Option3` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Image` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_Unit` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_Status` int NOT NULL DEFAULT '1',
  `Products_Note1` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Note2` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Note3` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Note4` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `Products_Note5` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `DateCreate` datetime NOT NULL,
  `LastUpdate` datetime NOT NULL,
  `Products_price` varchar(10) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `products` (`Products_ID`, `Types_ID`, `Categorys_ID`, `brand_ID`, `Products_Code`, `Products_Code2`, `Products_Name`, `Products_Description`, `Products_Option1`, `Products_Option2`, `Products_Option3`, `Products_Image`, `Products_Unit`, `Products_Status`, `Products_Note1`, `Products_Note2`, `Products_Note3`, `Products_Note4`, `Products_Note5`, `DateCreate`, `LastUpdate`, `Products_price`) VALUES
(000049, 0012, 0011, 000003, 'ITEM001100010001000001', NULL, 'แมวจี้', 'แมวดื้อ', NULL, NULL, NULL, 'images/products/ITEM001000010001_picture.jpg', 'ตัว', 1, NULL, NULL, NULL, NULL, NULL, '2021-01-13 16:55:15', '2021-01-13 16:55:15', '100'),
(000050, 0010, 0012, 000004, 'ITEM001200010002000001', NULL, 'แมวดื้อ', 'แมว', NULL, NULL, NULL, 'images/products/ITEM001200010002_picture.jpg', 'ตัว', 1, NULL, NULL, NULL, NULL, NULL, '2021-01-18 04:39:41', '2021-01-18 04:39:41', '200'),
(000051, 0010, 0012, 000005, 'ITEM001200020003000001', NULL, 'ชุดเดรส', 'ชุดสวยๆ', NULL, NULL, NULL, 'images/products/ITEM001200020003_picture.jpg', 'ชุด', 1, NULL, NULL, NULL, NULL, NULL, '2021-01-18 04:43:44', '2021-01-18 04:43:44', '169'),
(000052, 0012, 0011, 000006, 'ITEM001100020004000001', NULL, 'รองเท้า', 'รองเท้าทำงาน', NULL, NULL, NULL, 'images/products/ITEM001100020004_picture.png', 'คู่', 1, NULL, NULL, NULL, NULL, NULL, '2021-01-18 04:44:17', '2021-01-18 04:44:17', '300'),
(000054, 0011, 0013, 000001, 'ITEM001300010005000001', NULL, 'ชุดลำลอง', 'ชุดลำลองสวยๆ\r\nข้อความ ข้อความ\r\nข้อความ ข้อความ\r\nข้อความ ข้อความ', NULL, NULL, NULL, 'images/products/ITEM001300010005_picture.jpg', 'ชุด', 1, NULL, NULL, NULL, NULL, NULL, '2021-01-18 04:46:01', '2021-01-18 04:46:01', '300');
...
CREATE TABLE `products_categorys` (
  `Categorys_ID` int(4) UNSIGNED ZEROFILL NOT NULL,
  `Categorys_Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Types_ID` int(4) UNSIGNED ZEROFILL NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `products_categorys` (`Categorys_ID`, `Categorys_Name`, `Types_ID`) VALUES
(0011, 'ประเภทที่ 1', 0012),
(0012, 'ประเภทที่ 1', 0010),
(0013, 'ประเภทที่ 1', 0011);

-- --------------------------------------------------------

--
-- Table structure for table `products_claim`
--

CREATE TABLE `products_claim` (
  `pc_ID` int(6) UNSIGNED ZEROFILL NOT NULL,
  `Products_ID` int(6) UNSIGNED ZEROFILL NOT NULL,
  `note` varchar(2000) NOT NULL,
  `Orders_No` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Customer_ID` int(10) UNSIGNED ZEROFILL NOT NULL,
  `status` int NOT NULL DEFAULT '1',
  `pc_img` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `LastUpdate` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `products_claim`
--

INSERT INTO `products_claim` (`pc_ID`, `Products_ID`, `note`, `Orders_No`, `Customer_ID`, `status`, `pc_img`, `LastUpdate`) VALUES
(000001, 000051, 'ชุดขาด', 'ORD202101-0002 ', 0000000001, 1, NULL, '2021-01-20');
...
CREATE TABLE `products_quantity` (
  `Products_Quantity_ID` int(11) UNSIGNED ZEROFILL NOT NULL,
  `Products_Code` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_Quantity` int NOT NULL,
  `Products_Quantity_Date` date NOT NULL,
  `Products_Quantity_Time` time NOT NULL,
  `Products_Lot` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Employees_ID` varchar(10) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `Products_Quantity_Status` int NOT NULL DEFAULT '1',
  `Products_Quantity_Note` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `DateCreate` datetime NOT NULL,
  `LastUpdate` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `products_quantity` (`Products_Quantity_ID`, `Products_Code`, `Products_Quantity`, `Products_Quantity_Date`, `Products_Quantity_Time`, `Products_Lot`, `Employees_ID`, `Products_Quantity_Status`, `Products_Quantity_Note`, `DateCreate`, `LastUpdate`) VALUES
(00000000019, 'ITEM001100010001000001', 2, '2021-01-18', '13:00:41', 'LOT0000000001 ', '630500037', 1, 'เพิ่มสต็อคโดยแอดมิน', '2021-01-18 13:00:41', '2021-01-18 13:00:41'),
(00000000020, 'ITEM001200010002000001', 2, '2021-01-18', '13:00:54', 'LOT0000000002 ', '630500037', 1, 'เพิ่มสต็อคโดยแอดมิน', '2021-01-18 13:00:54', '2021-01-18 13:00:54'),
(00000000021, 'ITEM001200020003000001', 10, '2021-01-18', '13:01:02', 'LOT0000000003 ', '630500037', 1, 'เพิ่มสต็อคโดยแอดมิน', '2021-01-18 13:01:02', '2021-01-18 13:01:02'),
(00000000022, 'ITEM001100020004000001', 20, '2021-01-18', '13:01:10', 'LOT0000000004 ', '630500037', 1, 'เพิ่มสต็อคโดยแอดมิน', '2021-01-18 13:01:10', '2021-01-18 13:01:10'),
(00000000023, 'ITEM001300010005000001', 10, '2021-01-18', '13:01:18', 'LOT0000000005 ', '630500037', 1, 'เพิ่มสต็อคโดยแอดมิน', '2021-01-18 13:01:18', '2021-01-18 13:01:18'),
(00000000024, 'ITEM001100010001000001', 10, '2021-01-18', '13:02:53', 'LOT0000000001 ', '630500037', 1, 'เพิ่มสต็อคโดยแอดมิน', '2021-01-18 13:02:53', '2021-01-18 13:02:53'),
(00000000025, 'ITEM001200010002000001', 20, '2021-01-18', '13:03:01', 'LOT0000000002 ', '630500037', 1, 'เพิ่มสต็อคโดยแอดมิน', '2021-01-18 13:03:01', '2021-01-18 13:03:01'),
(00000000026, 'ITEM001100010001000001', -6, '2021-01-20', '08:01:36', 'LOT0000000001  ', '630500037', 1, 'ตัดสต็อคจากออเดอร์', '2021-01-20 08:01:36', '2021-01-20 08:01:36'),
(00000000027, 'ITEM001200020003000001', -6, '2021-01-20', '08:01:36', 'LOT0000000003  ', '630500037', 1, 'ตัดสต็อคจากออเดอร์', '2021-01-20 08:01:36', '2021-01-20 08:01:36'),
(00000000028, 'ITEM001100020004000001', -6, '2021-01-20', '08:01:36', 'LOT0000000004  ', '630500037', 1, 'ตัดสต็อคจากออเดอร์', '2021-01-20 08:01:36', '2021-01-20 08:01:36'),
(00000000029, 'ITEM001300010005000001', -6, '2021-01-20', '08:01:36', 'LOT0000000005  ', '630500037', 1, 'ตัดสต็อคจากออเดอร์', '2021-01-20 08:01:36', '2021-01-20 08:01:36');
...
CREATE TABLE `products_types` (
  `Types_ID` int(4) UNSIGNED ZEROFILL NOT NULL,
  `Types_Name` varchar(255) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `products_types` (`Types_ID`, `Types_Name`) VALUES
(0010, 'หมวดหมู่ที่ 1'),
(0011, 'หมวดหมู่ที่ 2'),
(0012, 'หมวดหมู่ที่ 3');
...
--
-- Indexes for table `products_categorys`
--
ALTER TABLE `products_categorys`
  ADD PRIMARY KEY (`Categorys_ID`);

--
-- Indexes for table `products_claim`
--
ALTER TABLE `products_claim`
  ADD PRIMARY KEY (`pc_ID`);

--
-- Indexes for table `products_quantity`
--
ALTER TABLE `products_quantity`
  ADD PRIMARY KEY (`Products_Quantity_ID`);
...
--
ALTER TABLE `banks`
  MODIFY `b_id` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `brand`
--
ALTER TABLE `brand`
  MODIFY `brand_ID` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `cart`
--
ALTER TABLE `cart`
  MODIFY `Cart_ID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `cart_detail`
--
ALTER TABLE `cart_detail`
  MODIFY `Cart_Detail_ID` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;

--
-- AUTO_INCREMENT for table `customers`
--
ALTER TABLE `customers`
  MODIFY `Customer_ID` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `customers_address`
--
ALTER TABLE `customers_address`
  MODIFY `ca_ID` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `news`
  MODIFY `News_ID` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `Orders_ID` int(10) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT for table `orders_detail`
--
ALTER TABLE `orders_detail`
  MODIFY `Orders_Detail_ID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=69;

--
-- AUTO_INCREMENT for table `payments`
--
ALTER TABLE `payments`
  MODIFY `payments_ID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `Products_ID` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `products_categorys`
--
ALTER TABLE `products_categorys`
  MODIFY `Categorys_ID` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `products_claim`
--
ALTER TABLE `products_claim`
  MODIFY `pc_ID` int(6) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `products_quantity`
--
ALTER TABLE `products_quantity`
  MODIFY `Products_Quantity_ID` int(11) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `products_types`
--
ALTER TABLE `products_types`
  MODIFY `Types_ID` int(4) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
